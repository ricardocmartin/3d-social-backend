...
namespace _3dSocial.Api.Controllers
{
    ...
    {
        private readonly ICenterFacade facade;

        public CenterController(ICenterFacade facade){
            this.facade = facade;
        }
        ...
        [HttpPost]
        public IActionResult Post([FromBody] Center item)
        {
            try
            {
                facade.Insert(item);
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Center item)
        {
            try
            {
                facade.Update(item);
